...
// ************** SERVO SETTINGS **************
#define SERVO_TC_PIN_0  {1 << 0,  PIOA, ID_PIOA, PIO_PERIPH_B, PIO_DEFAULT}
#define SERVO_TC_PIN_1  {1 << 26, PIOA, ID_PIOA, PIO_PERIPH_B, PIO_DEFAULT}
#define SERVO_PWM_PIN_2 {1 << 25, PIOA, ID_PIOA, PIO_PERIPH_B, PIO_DEFAULT}
#define SERVO_PWM_PIN_3 {1 << 24, PIOA, ID_PIOA, PIO_PERIPH_B, PIO_DEFAULT}
#define SERVO_TC_PIN_4  {1 << 16, PIOA, ID_PIOA, PIO_PERIPH_B, PIO_DEFAULT}
#define SERVO_PWM_PIN_5 {1 << 17, PIOA, ID_PIOA, PIO_PERIPH_C, PIO_DEFAULT}
#define SERVO_PWM_PIN_6 {1 << 23, PIOA, ID_PIOA, PIO_PERIPH_B, PIO_DEFAULT}

#define SERVO_OFF_PIN_0 {1 << 0,  PIOA, ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
#define SERVO_OFF_PIN_1 {1 << 26, PIOA, ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
#define SERVO_OFF_PIN_2 {1 << 25, PIOA, ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
#define SERVO_OFF_PIN_3 {1 << 24, PIOA, ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
#define SERVO_OFF_PIN_4 {1 << 16, PIOA, ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
#define SERVO_OFF_PIN_5 {1 << 17, PIOA, ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}
#define SERVO_OFF_PIN_6 {1 << 23, PIOA, ID_PIOA, PIO_OUTPUT_0, PIO_DEFAULT}

#define SERVO_ON_PINS  SERVO_TC_PIN_0, SERVO_TC_PIN_1, SERVO_PWM_PIN_2, \
                       SERVO_PWM_PIN_3, SERVO_TC_PIN_4, SERVO_PWM_PIN_5, \
                       SERVO_PWM_PIN_6,
